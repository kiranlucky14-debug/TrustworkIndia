...
export default function SignupPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: C.bg, display: 'flex', fontFamily: "'DM Sans',system-ui,sans-serif", position: 'relative' }}>
      ...
      {/* Right form panel */}
      <div className="tw-right" style={{ flex: 1, display: 'flex', alignItems: 'flex-start', justifyContent: 'center', padding: '32px 40px', position: 'relative', zIndex: 1, overflowY: 'auto', maxHeight: '100vh' }}>
        <div className="tw-scale" style={{ width: '100%', maxWidth: 500, background: C.card, border: '1px solid rgba(255,255,255,.08)', borderRadius: 24, padding: '32px 32px 28px', backdropFilter: 'blur(24px)' }}>
