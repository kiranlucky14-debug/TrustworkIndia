...
const { getConfig, updateConfig, testOtp, testEmail, systemHealth } = require('../controllers/systemConfigController')
...
// System config (admin settings panel)
router.get('/config',         getConfig)
router.patch('/config',       updateConfig)
router.post('/config/test-otp',   testOtp)
router.post('/config/test-email', testEmail)
router.get('/config/health',  systemHealth)
