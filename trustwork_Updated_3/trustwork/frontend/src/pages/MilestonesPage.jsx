      ...
      {step === 'method' && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[['upi', 'UPI', 'Google Pay, PhonePe'], ['card', 'Card', 'Debit / Credit']].map(([icon, label, sub]) => (
              <button key={label} onClick={fund}
                ...
                {icon === 'upi' ? (
                  <svg className="w-6 h-6 text-ink-300 group-hover:text-amber-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
                ) : (
                  <svg className="w-6 h-6 text-ink-300 group-hover:text-amber-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
                )}
              </div>
