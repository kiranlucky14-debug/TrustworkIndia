        ...
        <div className="tw-panel" style={{ width: '100%', maxWidth: 420, background: C.card, border: '1px solid rgba(255,255,255,.08)', borderRadius: 24, padding: '32px 32px 28px', backdropFilter: 'blur(24px)' }}>
          ...
          {step === 'role' && (
            <div className="tw-fade">
              ...
              <Link to="/signup" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '12px', borderRadius: 12, border: '1.5px solid rgba(255,255,255,.09)', color: 'rgba(255,255,255,.5)', textDecoration: 'none', fontSize: 14, fontWeight: 600, transition: 'all .15s' }}
          ...
          {step === 'phone' && ar && (
            <div className="tw-fade">
              ...
              <div style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: 'rgba(255,255,255,.3)' }}>
                New here? <Link to="/signup" style={{ color: accent, textDecoration: 'none', fontWeight: 600 }}>Create account</Link>
              </div>
            </div>
          )}
          ...
          {step === 'creds' && ar && (
            <div className="tw-fade">
              ...
              <div style={{ textAlign: 'center', marginTop: 16, fontSize: 13, color: 'rgba(255,255,255,.3)' }}>
                New here? <Link to="/signup" style={{ color: accent, textDecoration: 'none', fontWeight: 600 }}>Create a free account</Link>
              </div>
            </div>
          )}
